...
handler = logging.FileHandler('./logs/5_fold_cross_validations_logs/multi_cnn3_all_conv_lstm3_hybrid_model_{}.log'.format(date_time))
...
csv_logger = CSVLogger('./logs/5_fold_cross_validations_logs/per_epoch_multi_cnn3_all_conv_lstm3_hybrid_model{}'.format(date_time), append=True, separator=';')
...
for train_split, test_split in ksplit.split(shuffled_data):
    ...
    # Save model
    model.save('./models/5_fold_cross_validations_models/multi_cnn3_all_conv_lstm3_hybrid_model_{}_fold_{}'.format(date_time, fold))
